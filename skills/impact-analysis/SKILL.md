...
Use the Constellation `code_intel` tool to assess the impact of proposed code changes before they happen, identifying affected files, dependents, public API exposure, and risk level.
...
Call the Constellation `code_intel` tool with this code:
